...
export async function CampaignVisitors({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "rounded-[10px] bg-white shadow-1 black:bg-gray-black black:shadow-card",
        className,
      )}
    >
      <div className="border-b border-stroke px-6 py-5.5 black:border-black-3">
        <div className="flex justify-between">
          <h2 className="mb-1.5 text-2xl font-bold text-black black:text-white">
            Campaign Visitors
          </h2>

          <div className="mb-0.5 text-2xl font-bold text-black black:text-white">
