  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M6.75 2a.75.75 0 01.75.75v2.25h3V2.75a.75.75 0 011.5 0v2.25h3V2.75a.75.75 0 011.5 0v2.25h3a2.25 2.25 0 012.25 2.25v12a2.25 2.25 0 01-2.25 2.25H3a2.25 2.25 0 01-2.25-2.25V7.25A2.25 2.25 0 013 5h3V2.75a.75.75 0 01.75-.75zm-5.25 6h18v11.25a.75.75 0 01-.75.75H3a.75.75 0 01-.75-.75V8zm2.5 2.25a.75.75 0 01.75.75v5.25a.75.75 0 01-1.5 0v-5.25a.75.75 0 01.75-.75zm3-1.5a.75.75 0 01.75.75v6.75a.75.75 0 01-1.5 0V9a.75.75 0 01.75-.75zm3 2.25a.75.75 0 01.75.75v4.5a.75.75 0 01-1.5 0v-4.5a.75.75 0 01.75-.75zm3-1.5a.75.75 0 01.75.75v6a.75.75 0 01-1.5 0v-6a.75.75 0 01.75-.75z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M3 4.75A2.75 2.75 0 015.75 2h12.5A2.75 2.75 0 0121 4.75v3.188l-8.207 3.976a2.75 2.75 0 01-2.386 0L3 7.938V4.75zm0 5.175L11.207 13.9a1.25 1.25 0 001.086 0L21 9.925V19.25A2.75 2.75 0 0118.25 22H5.75A2.75 2.75 0 013 19.25V9.925z"
        fill="currentColor"
      />
    </svg>
  );
...
export function PaymentIcon(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2 4.75A2.75 2.75 0 014.75 2h14.5A2.75 2.75 0 0122 4.75v2.5a.75.75 0 01-1.5 0v-2.5a1.25 1.25 0 00-1.25-1.25H4.75a1.25 1.25 0 00-1.25 1.25v2.5H22v7H2.5v-7h-1V4.75zm0 9.5h20v5.75a2.75 2.75 0 01-2.75 2.75H4.75A2.75 2.75 0 012 19.75v-5.75zm4.5 3a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zm8.5 0a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z"
        fill="currentColor"
      />
    </svg>
  );
