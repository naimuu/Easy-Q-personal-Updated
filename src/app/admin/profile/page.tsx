    ...
    <div className="mx-auto w-full max-w-[970px]">
      ...
      <div className="overflow-hidden rounded-[10px] bg-white shadow-1">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            <h3 className="mb-1 text-heading-6 font-bold text-black">
              {data?.name}
            </h3>
            <p className="font-medium">Ui/Ux Designer</p>
            <div className="mx-auto mb-5.5 mt-5 grid max-w-[370px] grid-cols-3 rounded-[5px] border border-stroke py-[9px] shadow-1">
              ...
              <div className="flex flex-col items-center justify-center gap-1 border-r border-stroke px-4 xsm:flex-row black:border-black-3">
                <span className="font-medium text-black black:text-white">
                  129K
                </span>
            ...
            <div className="mx-auto max-w-[720px]">
              <h4 className="font-medium text-black black:text-white">
                About Me
              </h4>
              <p className="mt-4">
